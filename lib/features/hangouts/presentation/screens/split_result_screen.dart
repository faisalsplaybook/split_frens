...
class SplitResultScreen extends ConsumerWidget {
  ...
  const SplitResultScreen({super.key, required this.hangoutId});
            ...
            ...netBalances.entries.map((entry) {
              ...
              if (balance.abs() < 0.01) {
                return ListTile(
                  ...
                  trailing: const Text('Settled Up', style: TextStyle(color: Colors.grey)),
                );
              }
              ...
              return ListTile(
                ...
                subtitle: Text(
                  balanceText,
                  style: TextStyle(color: balanceColor, fontWeight: FontWeight.w500),
                ),
                trailing: Text(
